...
#                                                    print ('=====')                                                    
#                                                    print ('cv_at_server < min_cv_at_server :  cv_at_server=' \
#                                                           , cv_at_server, ' min_cv_at_server=', min_cv_at_server )
                                                    min_cv_at_server = cv_at_server
#                                                    print ('min_cv_at_server = cv_at_server')
                                                    service_chain_placement_vnf_server = (myChainRun, myBellRun, \
                                                            myPartionRun, myVNFRun, cpu[4], cpu[5], s[0], s[1], s[2], s[3] )
#                                                    print ('service_chain_placement_vnf_server = cpu')
...
#                                                    print ('=====')  
                                            ...
                                            """
#                                         print ('End of Server Loop ==> Only lowest cv_at_server in list.')
#                                         print ('cv_at_server=', cv_at_server)
...
#                                    service_chain_placement_vnf = service_chain_placement_vnf_server
                                    service_chain_placement_vnf.append( service_chain_placement_vnf_server)
#                                    print ('service_chain_placement_vnf=', service_chain_placement_vnf)
                                    
                            """
                            # Bottom of Partition Loop ==> Adding cv_at_vnf to Partition
                            """
                            cv_at_partition = cv_at_partition + cv_at_vnf     
#                            print ('cv_at_partition + cv_at_vnf')
#                            if (cv_at_partition < min_cv_at_partition):
#                            print ('PPPPP  cv_at_partition < min_cv_at_partition')                                                    
                            min_cv_at_partition = cv_at_partition
#                            print ('min_cv_at_partition = cv_at_partition')
                            service_chain_placement_partition.append(service_chain_placement_vnf)
#                            print ('service_chain_placement_partition.append')
#                            print (service_chain_placement_partition)
                            myPartitionServer = myVNFServer
#                            myBellServer = myPartitionServer                                
#                            print ('PPPPP')    
                    """
...
#                    print ('cv_at_bell + cv_at_partition')
#                    print ('cv_at_bell=', cv_at_bell, '  min_cv_at_bell=', min_cv_at_bell)
                    if (cv_at_bell < min_cv_at_bell):
#                        print ('BBBBB   cv_at_bell < min_cv_at_bell ')     
                        service_chain_placement_bell = []                                               
                        min_cv_at_bell = cv_at_bell
#                        print ('min_cv_at_bell = cv_at_bell')
                        service_chain_placement_bell.append(service_chain_placement_partition)  # adding cv_at_bell
#                        print ('service_chain_placement_bell.append')
#                        print (service_chain_placement_bell)    
#                        print (myPartitionServer)
...
#            for a, b, c, d ,e , f, g, h, i, j in service_chain_placement_chain :
#                print ("Service Chain ID=", a, \
#                       " Bell ID=", b, \
#                       " Partition ID=", c, \
#                       " VNF ID=", d, \
...
#    print (myPartition_Chain)
    ...
    """
    print (optimal_cost_placement.service_chain_placement.sort() )
