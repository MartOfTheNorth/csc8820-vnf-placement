...
#    [30, 29, 31, 21, 26, 25, 23, 21, 31, 20, 27, 20, 25, 18, 29
#       Anh's requirement
#        server_topology = [
#             ('s1', 'c30', 'u0','a27', 'l0'),
#             ('s2', 'c29', 'u0','a26', 'l0'),
...
#        return (random.uniform(0, 1))
    ...
    def cost_of_virtual_switching_calculator(self,chain, bell, partition, vnf, \
        ...
        """
#        print ('vnf_length=', vnf_length)
        a = 0.0
        if (vnf_length == 'l0' ):
#            print ('vnf_length[1:]==0')
            vnf_length = 'l1'
...
class greedy_longest_subchain():
    """
    greedy_longest_subchain
    Goal : Find a deployment strategy such that end-to-end delay is minimized​

    Approach: Sort server by the available CPU. 
    Then assigns the longest sub-chains to servers with smallest/largest available CPUs.
    ...
    def print_all_list():
        ...
        for a, b, c, d ,e , f, g, h, i, j in greedy_longest_subchain.service_chain_placement  :
    ...
    def perform_placement(self):
        ...
        Output:
            - List of tuple : Chain, VNF, Server
...
#        def custom_sort(t):
#            return t[0]  # Sort by Server ID
#            return t[1]  # Sort by Total number of cpu
#            return t[2]  # Number of used cpu
#            return t[3]  # Sort by Available CPU
        """        
        # End of def
        """
...
#                                    print ('myVNFListTotalCPUinPartition=', myVNFListTotalCPUinPartition)
...
#                                return t[2]  # Number of used cpu
                                return t[3]  # Sort by Available CPU
#            
#                            myPartitionServer.sort(key=custom_sort)                # ascending  123
                            myPartitionServer.sort(key=custom_sort, reverse=True)   # descending 321 
...
#                                                        print ('s[0]=', s[0])
                                                        ...
                                                        if (myVNFListTotalCPUinPartition <= float(m1(s[3])) ):
                                                            match_at_server = True
#                                                            print('match_at_server = True')
        #                                                if ((cv_at_server+myVNFListTotalCPUinPartition) < min_cost_at_server ):
#                                                        if ((cv_at_server) < min_cost_at_server ):
                                                            cv_at_server = 0
#                                                            print('==============cv_at_server < min_cost_at_server')
#                                                            print('min_cost_at_server=',min_cost_at_server)
#                                                            print('(cv_at_server+myVNFListTotalCPUinPartition)=',(cv_at_server+myVNFListTotalCPUinPartition) )
        #                                                    min_cost_at_server = (cv_at_server+myVNFListTotalCPUinPartition)                                                         
                                                            min_cost_at_server = cv_at_server                                                        
#                                                            print('min_cost_at_server=',min_cost_at_server)
...
#                                                            print('service_chain_placement_vnf_server=',service_chain_placement_vnf_server)
                                                            # If match_at_server = True' , break the server for loop
                                                            break
                                                        else:
#                                                            print (s[0], ' with ', m1(s[3]) , ' has no resource for',myVNFListTotalCPUinPartition )
                                                            cv_at_server = 9999
                                                            service_chain_placement_vnf_server = (myChainRun, myBellRun, \
                                                                    myPartitionRun, myVNFRun, cpu[4], cpu[5], s[0], s[1], \
                                                                    s[2], s[3], s[4], ('l'+str(myVNFLengthinPartition)), ('t'+str(myVNFListTotalCPUinPartition)), \
...
#                                    print ('service_chain_placement_vnf_server', len(service_chain_placement_vnf_server))
...
#                            print ('myPartitionServer=', myPartitionServer)
                            """
                            # Reset at the end of Partition 
                            # myVNFLengthinPartition to 0
                            # match_at_server = False
                            """                       
                            myVNFLengthinPartition = 0
                            match_at_server = False
                    ...
                    """
#                    print ('min_cost_at_partition =',  min_cost_at_partition)                    
                    """
                    # Bottom of Bell Loop    
                    """
                    cv_at_bell = cv_at_bell + cv_at_partition    
#                    print('Bottom of Bell Loop: cv_at_bell=', cv_at_bell)
                    if (cv_at_bell < min_cost_at_bell): 
                        service_chain_placement_bell = []                                               
                        min_cost_at_bell = cv_at_bell
...
#                        print ('BBBBB')   
            ...
            """
#            print ('min_cost_at_bell =',  min_cost_at_bell)      
#            print ('Length of Bell =', len(service_chain_placement_bell))
#            if (len(service_chain_placement_bell) == 0 ):
#                print ('service_chain_placement_bell) = 0')
...
#            print ("VNF Length   =", e)  
# End of class greedy_longest_subchain(object):
...
#    myPartition_Chain.print_all_list()    
    ...
    """
    myService_Chain_Placement = greedy_longest_subchain \
    ...
    print ("")     
    print ("Summary View.")     
#    print (greedy_longest_subchain.service_chain_placement)
    def list_all(obj):
        if not isinstance(obj, list):
            return [obj]
        else:
    ...
    greedy_longest_subchain.service_chain_placement = (list_all(greedy_longest_subchain.service_chain_placement))   
    for s in greedy_longest_subchain.service_chain_placement:
            print (s)    
    print ("") 

#    print (greedy_longest_subchain.service_chan_all)    
#    for s in greedy_longest_subchain.service_chan_all:
#            print (s)
