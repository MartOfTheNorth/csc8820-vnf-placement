                                                        ...
                                                        if ((cv_at_server) < min_cv_at_server ):                                                  
                                                            if ((cv_at_server+myVNFListTotalCPUinPartition) > float(m1(s[3])) ):
                                                                service_chain_placement_vnf_server = (myChainRun, myBellRun, \
                                                                        myPartitionRun, myVNFRun, cpu[4], cpu[5], 's', 'c0', \
                                                                        'u0', 'a0', 'l0', ('l'+str(myVNFLengthinPartition)), ('t'+str(myVNFListTotalCPUinPartition)), \
                                                                        ('cv9999'))                                                                    
                                                                match_at_server = False
                                                            else:
...
#                                            """
                                    ...
                                    if (match_at_server):
                                        ...
                                        match_at_partition = True
                                    elif (match_at_partition):
                                                service_chain_placement_vnf_server = (myChainRun, myBellRun, \
                                                        myPartitionRun, myVNFRun, 'u', \
                                                        'o', 's', 'c', \
                    ...
                    if (cv_at_bell < min_cv_at_bell) and (match_at_partition): 
                        service_chain_placement_bell = []                                               
            ...
            myChainCostTuple = myChainCostTuple + ((str(min_cv_at_bell)),)
...
#        print ('service_chain_server_result ==== ', service_chain_server_result)           
...
if __name__ == '__main__':
    ...
    print('==OPERATIONAL SWITCHING COST MINIMIZATION==')
